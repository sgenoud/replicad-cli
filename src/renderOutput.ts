...
export function renderAsJSON(shapes: Array<CleanConfig>) {
...
export function standardizeOutput(
  shapes: unknown,
  ...
  return standardizer.standardizeShape(baseShape);
}
